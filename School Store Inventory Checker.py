items = ["pencil", "eraser", "notebook", "sharpener", "glue", "cards"]
stock_counts = [12, 5, 8, 5, 3, 10]
...
print(chosen_item, "purchased! Remaining stock:",
inventory[chosen_item])
